...
String Error="error";
    ...
    protected String doInBackground(String... params) {
        ...
        String login_url="http://"+MainActivity.server_ip+"/Planmap/login.php";
        String signup_url="http://"+MainActivity.server_ip+"/Planmap/signup.php";
        String createevent_url="http://"+MainActivity.server_ip+"/Planmap/createevent.php";
        String listevents_url="http://"+MainActivity.server_ip+"/Planmap/events_json.php";
        String checkusername_url="http://"+MainActivity.server_ip+"/Planmap/checkusername.php";
        String addpeepurl="http://"+MainActivity.server_ip+"/Planmap/addtheselectedpeep.php";
